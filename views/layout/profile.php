			...
			<section>
				...
				<div class="lg:w-8/12 lg:mx-auto mb-8">
					...
					<div class="w-8/12 md:w-7/12 ml-4">
						...
						<!-- follow button -->
						<a href="#" @click="swal()" class="bg-blue-500 px-2 py-1 
   ...
   <?php include __DIR__ .'/footer.php'; ?>
	<script defer>
		new Vue({
			...
			methods:{
				checkIfMobile() {
                // Update the 'isMobile' property based on the current window width
                    this.isMobile = window.innerWidth <= 1024; // You can adjust the threshold as needed
                    if(  this.isMobile ){
                        this.aside = false;
                    }
                },
